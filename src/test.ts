...
describeOrSkip('Zcash-Mina Bridge Complete Test', () => {
  ...
  describe('Zcash Proof Verification', () => {
    ...
    it('should verify proof with ZkProgram', async () => {
      ...
      expect(verification.publicOutput.amount).toEqual(UInt64.from(1000000));
      expect(verification.publicOutput.txHash).toEqual(txHash);
    ...
    it('should reject invalid proofs', async () => {
      ...
      const invalidProof = new ZcashShieldedProof({
        ...
        valueBalance: UInt64.from(1000000),
        proofA: Field(7),
        proofB: Field(8),
        proofC: Field(9),
      });
    ...
    it('should recursively verify batch of proofs', async () => {
      ...
      expect(verification2.publicOutput.amount).toEqual(UInt64.from(750000));
  ...
  describe('Full Mint Flow', () => {
    it('should mint zkZEC with full verification', async () => {
      ...
      // 6. Verify minting (removed totalMinted check as per instruction)
